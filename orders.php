		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" method="POST" >
                    ...
                    <input type="text"  name="selected_category_id_update" required id="selected_category_id_update">
                    <input type="submit"  name="editCategorySubmit" id="editCategorySubmit">
